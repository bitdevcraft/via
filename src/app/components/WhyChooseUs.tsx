  ...
  return (
    <div className="max-w-[1144px] px-6  mx-auto mb-[140px] pt-[100px] ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-8 md:grid-cols-12 gap-[32px]">
        <div className="col-span-1 sm:col-span-4 md:col-span-5 border rounded-lg h-[320px]"></div>
        <div className="col-span-1 sm:col-span-4 md:col-span-7 border rounded-lg h-[320px]"></div>
        <div className="col-span-1 sm:col-span-4 md:col-span-7 border rounded-lg h-[320px]"></div>
        <div className="col-span-1 sm:col-span-4 md:col-span-5 border rounded-lg h-[320px]"></div>
      </div>
    </div>
